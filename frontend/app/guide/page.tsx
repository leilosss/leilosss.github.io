...
const STEPS = [
  ...
  },
  {
    ...
    en: "PASTE INTO TRIM",
    t: "粘贴到 Trim",
    d: "回到本站按 Ctrl + V(手机长按粘贴)。识别在你的浏览器里完成。",
    icon: ClipboardCopy,
  },
  {
    n: "03",
...
const FAQS = [
  ...
  { q: "需要注册或绑定银行卡吗?", a: "都不需要。Trim 不接触你的账号、密码或银行卡,只读你主动粘贴的那段文字。" },
  ...
  { q: "支持哪些账单?", a: "微信支付与支付宝的账单文本;也支持拖入支付宝 CSV、微信 xlsx / csv 文件(同样只在本机解析)。" },
];
